...
const DEPT_ORDER: StaffDepartment[] = [
  ...
  "Store", "IT", "HR", "Administration", "Non-Clinical Staff", "NHIS",
];
...
const DEPT_META: Record<StaffDepartment, { icon: string; color: string; description: string }> = {
  ...
  "NHIS":               { icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z", color: "text-blue-600 bg-blue-50", description: "NHIS officers managing HMO schemes, patient enrollments, and insurance claims." },
};
