    ...
    <div className="mx-auto max-w-lg space-y-5 pb-24">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="space-y-1">
          <Link
            href="/staff/profile"
            className="flex items-center justify-between rounded-xl px-3 py-3 text-sm font-medium text-slate-700 hover:bg-slate-50 transition"
          >
            <span>My Staff Profile &amp; Payslips</span>
