  ...
  frontdesk: [
    {
      ...
      items: [
        ...
        { label: "Store Requests", href: `${INTERNAL_PREFIX}/frontdesk/store-requests`, icon: "queue" },
  ...
  doctors: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Store Requests", href: `${INTERNAL_PREFIX}/doctors/store-requests`, icon: "queue" },
      ],
    },
    {
      section: "Records",
      items: [
        ...
        { label: "Rota Management", href: `${INTERNAL_PREFIX}/doctors/rota`, icon: "calendar" },
        { label: "Leave Requests", href: `${INTERNAL_PREFIX}/doctors/leave`, icon: "calendar" },
        { label: "Staff Performance", href: `${INTERNAL_PREFIX}/doctors/performance`, icon: "reports" },
  ...
  nurses: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Store Requests", href: `${INTERNAL_PREFIX}/nurses/store-requests`, icon: "queue" },
        { label: "Rota Management", href: `${INTERNAL_PREFIX}/nurses/rota`, icon: "calendar" },
        { label: "Leave Requests", href: `${INTERNAL_PREFIX}/nurses/leave`, icon: "calendar" },
        { label: "Staff Performance", href: `${INTERNAL_PREFIX}/nurses/performance`, icon: "reports" },
  ...
  pharmacy: [
    {
      ...
      items: [
        ...
        { label: "Rota Management", href: `${INTERNAL_PREFIX}/pharmacy/rota`, icon: "calendar" },
        { label: "Leave Requests", href: `${INTERNAL_PREFIX}/pharmacy/leave`, icon: "calendar" },
        { label: "Staff Performance", href: `${INTERNAL_PREFIX}/pharmacy/performance`, icon: "reports" },
  ...
  lab: [
    {
      ...
      items: [
        ...
        { label: "Store Requests", href: `${INTERNAL_PREFIX}/lab/store-requests`, icon: "queue" },
        { label: "Rota Management", href: `${INTERNAL_PREFIX}/lab/rota`, icon: "calendar" },
        { label: "Leave Requests", href: `${INTERNAL_PREFIX}/lab/leave`, icon: "calendar" },
        { label: "Staff Performance", href: `${INTERNAL_PREFIX}/lab/performance`, icon: "reports" },
